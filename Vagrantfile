...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  $rootscript = <<SCRIPT
  apt-get update
  apt-get install -y xinit fluxbox subversion maven2 r-base libjpeg62 default-jdk default-jre libgstreamer-plugins-base0.10-0 dkms build-essential virtualbox-guest-x11 feh

  cd /tmp
  wget http://download1.rstudio.org/rstudio-0.98.1102-amd64.deb
  dpkg -i rstudio-0.98.1102-amd64.deb
